...
bool handle_search_input(WINDOW *win, struct Page *page, int key,char searchStr[], int *searchStrPos)
{
	int x, y;
	getyx(win, y, x);
...
bool handle_replace_input(WINDOW *win, struct Page *page, int key,const char searchStr[],char replaceStr[], int* replaceStrPos)
{
	int x, y;
	getyx(win, y, x);
